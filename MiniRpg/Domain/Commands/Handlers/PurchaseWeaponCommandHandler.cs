...
namespace MiniRpg.Domain.Commands.Handlers
{
    public class PurchaseWeaponCommandHandler : CommandHandlerBase<PurchaseWeaponCommand>
    {
        ...
        protected override ExecutionResult HandleImpl(Player player)
        {
            ...
            {
                return ExecutionResult.Failed("Not enough coins to buy a weapon. Go and kill monsters!");
            }
            ...
            return ExecutionResult.Succeeded($"Purchased a weapon with power bonus {bonus}");
        }
    }
}